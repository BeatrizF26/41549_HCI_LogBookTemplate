...
| Impossibilidade de ver vídeos                | 4             | Garantir que aparece uma lista de vídeos e depois se possa assistir o vídeo ou então assistir diretamente o vídeo               |
...
| **Issue**       | **Severity** | Recommendation |
| --------------- | ------------ | -------------- |
| Cores muito monótonas| 1           | Recorrer a uma maior paleta de cores para se conseguir distinguir visualmente melhor os aspetos              |
| Fontes de texto pequenas que dificultam a leitura   | 2            | Utilizar fontes diferentes ou então aumentar o tamanho              |
